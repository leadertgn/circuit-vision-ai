      ...
      <div className="max-w-4xl mx-auto space-y-4">
        ...
        <div className="grid grid-cols-3 gap-4">
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-4">
            ...
            <p className="text-lg font-bold text-purple-600">{detectedPlatform}</p>
          </div>
        </div>
        ...
        <div className="bg-blue-50 rounded-lg p-4 border border-blue-200">
          <p className="text-sm text-blue-900">
            <strong>💡 Tip:</strong> Click "Simulate" to test your circuit in Wokwi. LEDs blink,
            sensors react in real-time! Platform auto-detected: <strong>{detectedPlatform}</strong>
          </p>
        </div>
      </div>
    </div>
